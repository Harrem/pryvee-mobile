...
import 'package:pryvee/src/screens/user_inside/my_map.dart';
        ...
        child: ListView(
          ...
          children: [
            ...
            Container(
              ...
              child: TextFormField(
                validator: ((value) =>
                    value.isEmpty ? "Enter country name" : null),
                onChanged: (String value) =>
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: TextFormField(
                      validator: ((value) =>
                          value.isEmpty ? "Enter address name" : null),
                      onChanged: (String value) =>
            ...
            CommunChipWidget(
              onTap: () => Navigator.push(
                ...
                debugPrint("got location: $latLng");
                checkDatingLatLng = latLng;
              }),
              edgeInsetsGeometry:
                  EdgeInsets.symmetric(vertical: 6.0, horizontal: 12.0),
              boxBorder: Border.all(color: APP_COLOR, width: 1.0),
              ...
              children: [
                Expanded(
                  child: Container(
                    ...
                    child: TextFormField(
                      validator: ((value) =>
                          value.isEmpty ? "Enter transport method" : null),
                      onChanged: (String value) =>
                ...
                Expanded(
                  child: Container(
                    ...
                    child: TextFormField(
                      validator: ((value) =>
                          value.isEmpty ? "Enter car plate number" : null),
                      onChanged: (String value) =>
            ...
            CommunTextButtonWidget(
              onPressed: () async {
                if (!formKey.currentState.validate()) {
                  showToast(context, "Please fill empty fields");
                  return;
                } else if (checkTrustedUser == null) {
                  showToast(context, "Please select a trusted user");
                } else {
                  Post post = Post(
                    ...
                    dateUserLatitude: checkDatingLatLng.latitude,
                    dateUserLongitude: checkDatingLatLng.longitude,
